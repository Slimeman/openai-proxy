...
1. Сделай от 10 до 25 таймкодов, в зависимости от длины видео.
...
4. Не используй нумерацию, звёздочки, Markdown и лишние символы. Только таймкод, длинное тире и текст.
...
Сделай аккуратный финальный список таймкодов (примерно 15–25), строго в формате:

00:00 — Краткое описание момента

Без Markdown, без звёздочек, без нумерации. Всё на русском языке. Таймкоды должны быть уникальными, с разными временными метками и хорошо описывать ключевые повороты сюжета или вопросы интервьюера.
`.trim();
