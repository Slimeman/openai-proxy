...
Без Markdown, без звёздочек, без нумерации и лишних символов. Всё на русском языке. Таймкоды должны быть уникальными, с разными временными метками и хорошо описывать ключевые повороты сюжета или вопросы интервьюера.
`.trim();
